...
def main():
    ...
    # Generate Mermaid diagrams (timeline, debate map, signal quadrant)
    # Mindmaps are NOT generated by Mermaid — they are handled by PaperBanana (--with-paperbanana)
    ...
    if args.with_paperbanana:
        ...
        # 2. Connections map (replaces Mermaid mindmap)
        if connections:
